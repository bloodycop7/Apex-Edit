...
local function DrawInfo(ply)
	...
	if not HL2RP_texCache["SilkHunger"] then HL2RP_texCache["SilkHunger"] = Material("icon16/hourglass.png") end
	...
	surface.DrawTexturedRect(18,ScrH() - 190,16,16)
	draw.DrawText( "" .. LocalPlayer():Nick() , "Trebuchet24", RelativeX + 40, RelativeY - HUDHeight - 80, Color(255, 255, 255, 255), 0)
	...
	surface.DrawTexturedRect(18,ScrH() - 165,16,16)
	draw.DrawText("" .. job, "Trebuchet24", RelativeX + 40, RelativeY - HUDHeight - 55, team.GetColor(LocalPlayer():Team()), 0)

	surface.SetMaterial(HL2RP_texCache["SilkHeart"])
	surface.DrawTexturedRect( RelativeX + 100,ScrH() - 135,16,16)
	draw.DrawText("Health: " .. LocalPlayer():Health() .. "%", "Trebuchet24", RelativeX + 125, ScrH() - 140, Color(255, 255, 255), 0)

	surface.SetMaterial(HL2RP_texCache["SilkMoney"])
	surface.DrawTexturedRect( RelativeX + 100,ScrH() - 110,16,16)
	draw.DrawText("Money: " .. "T" .. money or 0, "Trebuchet24", RelativeX + 125, ScrH() - 115, Color(255, 255, 255), 0)

	surface.SetMaterial(HL2RP_texCache["SilkHunger"])
	surface.DrawTexturedRect( RelativeX + 100,ScrH() - 85,16,16)
	draw.DrawText("Hunger: " .. energy .. "%", "Trebuchet24", RelativeX + 125, ScrH() - 90, Color(255, 255, 255), 0)

	if LocalPlayer():Team() == TEAM_CP or LocalPlayer():Team() == TEAM_OVERWATCH then
		surface.SetDrawColor(0,0,0,190)
		surface.DrawRect(1560,700,400,90)
		draw.DrawText("Local Unit's ID: " .. LocalPlayer():Nick() ,"Trebuchet24", RelativeX + 1560, ScrH() - 380, Color(255, 255,255), TEXT_ALIGN_LEFT )
		draw.DrawText("Local Unit's Health: " .. LocalPlayer():Health() ,"Trebuchet24", RelativeX + 1560, ScrH() - 350, Color(255, 255,255), TEXT_ALIGN_LEFT )
		draw.DrawText("AP Charge: " .. LocalPlayer():Armor() .. "%", "Trebuchet24", RelativeX + 1560, ScrH() - 320, Color(255, 255, 255), TEXT_ALIGN_LEFT )
	end
...
local function DrawWarningBox(weaponName)
	draw.RoundedBox(0, 10, Scrh - HUDHeight - 160, HUDWidth, 70, Color( 40, 0, 0, 240 ) )
	surface.SetDrawColor(255,255,255)
	surface.SetMaterial(HL2RP_texCache["SilkWarning"])
	surface.DrawTexturedRect(20,ScrH() - 244,16,16)
	surface.SetDrawColor(255,255,255)
	surface.SetMaterial(HL2RP_texCache["SilkWarning"])
	surface.DrawTexturedRect(245,ScrH() - 244,16,16)
	draw.DrawText("You should only use the "..weaponName.."\n    while building. Using it in a RP \n situation is FailRP and punishable.",  "NameFont", RelativeX + 30, RelativeY -  265, Color(255, 255, 255, 255), 0)
end
...
local function DrawSide()
	...
	draw.DrawText("XP: " .. xp, "Trebuchet24", ScrW() - 1820, 1030, Color(255, 255, 255), 0)

	draw.RoundedBox(0, ScrW() - 120, 120, 140, 50, Color( 0, 0, 0, 230) )
	draw.DrawText("Time: " .. os.date( "%H:%M" ), "Trebuchet24", ScrW() - 120, 130, Color(255, 255, 255, 255), 0)
...
local function DrawHUD()
	...
	--Background
	draw.RoundedBox(0, 10, 880, 300, 180, Color(0,0,0,190))
