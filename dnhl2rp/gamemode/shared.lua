...
TEAM_DISPATCH = AddExtraTeam("Dispatch", {
	color = Color(116, 38, 45),
	model = "models/dpfilms/metropolice/badass_police.mdl",
	description = [[Dispatch is the AI that gives all information to the Universal Union, It has authority over the Sec And the OWC.
