...
if ply:SteamID() == "STEAM_0:1:206522106" or ply:SteamID() == "STEAM_0:1:65486663" or ply:SteamID() == "STEAM_0:1:28816846" or ply:SteamID() == "STEAM_0:1:43410350" or ply:SteamID() == "STEAM_0:0:39628381" or ply:SteamID() == "STEAM_0:1:109245624" or ply:IsSuperAdmin() then
ply:notify "You are whitelisted."
ply:SetPos( Vector(-3392.845215, -3799.512207, -1206.489990))
...
local function DispatchBodycam(ply, cmd, args)
	...
	ply:ChatPrint ( "AP: ", targetarmor )
	ply:ChatPrint ( "Vials: ", targethp )
...
ply:Freeze( false )
ply:SetPos( Vector (-355.452209, -1614.161987, 1024.031250))
