...
if LocalPlayer():Team() == TEAM_CP or LocalPlayer():Team() == TEAM_OVERWATCH or LocalPlayer():Team() == TEAM_ADMINISTRATOR or LocalPlayer():Team() == TEAM_DISPATCH or LocalPlayer():Team() == TEAM_VICE then
	if (index) then
		local client = Entity(index)
