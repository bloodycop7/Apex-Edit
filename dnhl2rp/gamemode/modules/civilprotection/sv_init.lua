...
voice.defineClass("combine", function(client)
	...
	if (chatType == "dispatch" or chatType == "g" or chatType == "y" or client:isCombineRank("SCN")) then
		return false
	end
...
voice.register("combine", "COME WITH ME", "You citizen, come with me.", "")
...
if client:Team() == TEAM_CP or client:Team() == TEAM_OVERWATCH or client:Team() == TEAM_ADMINISTRATOR or client:Team() == TEAM_DISPATCH or client:Team() == TEAM_VICE then 
	local volume = 80;
