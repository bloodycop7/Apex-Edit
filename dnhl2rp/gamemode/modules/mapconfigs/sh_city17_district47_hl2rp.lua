...
if LastJw and LastJw + 15 > CurTime() then return false end
		...
		if string.match( p:Name(), "CmD" ) or string.match( p:Name(), "OWC" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
...
check = function(p)
	...
	if p:IsCP() or p:IsAdmin() then
		...
		if string.match( p:Name(), "DcO" ) or string.match( p:Name(), "CmD" ) or string.match( p:Name(), "OTA-C17-" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
...
check = function(p)
	...
	if p:IsCP() or p:IsAdmin() then
		...
		if string.match( p:Name(), "DcO" ) or string.match( p:Name(), "CmD" ) or string.match( p:Name(), "JURY" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
...
check = function(p)
	...
	if p:IsCP() or p:IsAdmin() then
		...
		if string.match( p:Name(), "DcO" ) or string.match( p:Name(), "CmD" ) or string.match( p:Name(), "OWC" ) or string.match( p:Name(), "JURY" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
...
check = function(p)
	...
	if p:IsCP() or p:IsAdmin() then
		...
		if string.match( p:Name(), "DcO" ) or string.match( p:Name(), "CmD" ) or string.match( p:Name(), "OWC" ) or string.match( p:Name(), "CCA-C17-DvL-JURY" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
...
check = function(p)
	if p:IsCP() or p:IsAdmin() then
		...
		if string.match( p:Name(), "DcO" ) or string.match( p:Name(), "CmD" ) or string.match( p:Name(), "OWC" ) or string.match( p:Name(), "CCA-C17-DvL" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
...
check = function(p)
	if p:IsCP() or p:IsAdmin() then
		...
		if string.match( p:Name(), "DcO" ) or string.match( p:Name(), "CmD" ) or p:Team() == TEAM_OVERWATCH or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
