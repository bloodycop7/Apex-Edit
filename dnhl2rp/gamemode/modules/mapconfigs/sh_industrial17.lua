...

{
	...
	check = function(p)
		...
		if string.match ( p:Name(), "CmD" ) or string.match( p:Name(), "SqL" ) or string.match( p:Name(), "CmD" ) or string.match( p:Name(), "DvL" ) or string.match( p:Name(), "JURY-DvL" ) then
			
			p:notify("Access Granted to Tracks.")
			...
			p:notify("Access denied to Tracks.")
...
check = function(p)
	...
	if string.match( p:Name(), "CmD" ) or string.match( p:Name(), "DvL" ) or string.match( p:Name(), "OWC" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
...
check = function(p)
	...
	if string.match( p:Name(), "CmD" ) or string.match( p:Name(), "OWC" ) or string.match( p:Name(), "DvL" ) or p:Team() == TEAM_ADMINISTRATOR or p:IsAdmin() then
