...
function OWNPCShopMenu()
	...
	-- Small derma panel just for the example.
		...
		OWMenu:SetSize(720, 670)
		OWMenu:Center()
		OWMenu:SetVisible( true )
		OWMenu:MakePopup()
		OWMenu.Paint = function( self, w, h ) -- 'function Frame:Paint( w, h )' works too
			draw.RoundedBox( 0, 0, 0, w, h, Color( 0,0,0, 200 ) )
			draw.RoundedBox( 0, 0, 0, w, 25, Color(30, 30, 30, 190) ) -- Draw a red box instead of the frame



			draw.RoundedBox( 0, 20, 390, 350, 20, Color( 100,100,100, 220)) -- RANK

			draw.RoundedBox( 0, 20, 117, 350, 20, Color( 100,100,100, 220)) --DIVISION
...
--OWDivision Block XP Requirement
		...
		OWDivisionXPLabel = vgui.Create( "DLabel", OWMenu )
			OWDivisionXPLabel:SetPos( 20, 330 )
...
--Rank XP Requirement Corner
		...
		local DRankBox = vgui.Create( "DDropListBox", OWMenu )
				...
				DRankBox:AddChoice( "LDR - Overwatch Leader", 3 )
	...
	function icon:LayoutEntity(Entity)
		...
		local Button = vgui.Create( "DButton", OWMenu )
			...
			Button.Paint = function( self, w, h )
				...
				surface.DrawRect(160,0,500,25) -- Draw a blue button
			end
